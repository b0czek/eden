...
function generateRuntimeJS(
  ...
  lines.push(" * AUTO-GENERATED FILE - DO NOT EDIT");
  lines.push(" * ");
  lines.push(" * This file contains runtime arrays for command and event names.");
...
export function generateCommands() {
  ...
  console.log(`✅ Generated ${path.relative(projectRoot, runtimeJSOutputPath)}`);
  ...
  console.log(`✅ Generated ${path.relative(projectRoot, runtimeDTSOutputPath)}`);
}
