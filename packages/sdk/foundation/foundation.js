...
(function () {
    ...
    function createBaseLayer() {
        ...
        layer.style.background = 'linear-gradient(135deg, #1e1e2e 0%, #1a1b26 100%)';
    ...
    if (container) {
        ...
        window.edenAPI.shellCommand('appearance/get-wallpaper', {})
            .then(response => {
    ...
    function applyNewWallpaper(cssValue) {
        ...
        const cleanup = () => {
            ...
            const layers = Array.from(container.getElementsByClassName('wallpaper-layer'));
