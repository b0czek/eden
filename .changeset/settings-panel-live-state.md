...
Allow trusted hosts to register panels without an additional grant, so public parent panels and children that inherit their ancestors' access rules use the same registration API.
